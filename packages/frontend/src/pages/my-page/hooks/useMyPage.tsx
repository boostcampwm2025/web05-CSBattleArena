...
import { ApiError, fetchMyPageProfile, fetchTierHistory } from '@/lib/api/my-page';
import type { MyPageResponse, TierHistoryResponse } from '@/shared/type';
...
export function useMyPage() {
  ...
  useEffect(() => {
    ...
    // 2개의 API를 독립적으로 호출 (각각 완료되는 대로 렌더링)
    void Promise.all([loadProfileData(), loadTierHistory()]).finally(() => {
      setIsLoading(false);
    });
  }, [accessToken, loadProfileData, loadTierHistory]);
